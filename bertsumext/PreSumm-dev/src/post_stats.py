...
def cal_repeat(args):
    candidate_lines = open(args.result_path+'.candidate', encoding="utf-8").read().strip().split('\n')
    gold_lines = open(args.result_path+'.gold', encoding="utf-8").read().strip().split('\n')
    src_lines = open(args.result_path+'.raw_src', encoding="utf-8").read().strip().split('\n')
